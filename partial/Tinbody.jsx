        ...
        <div className="mx-auto ">
            <div className="lg:grid grid-cols-12">
                ...
                <div className="col-span-10">
                    <div className="flex">
                        ...
                        <div className="lg:w-1/4 hidden lg:block   ">
                            <div className="border-2 border-gray p-2 mb-2 ">
                                <div className="border-b-4 border-red">XEM NHIỀU</div>
                                <RightTop New={Left1} n={4} />
                            </div>
                            <div className="border-2 sticky top-12 border-gray p-2 ">
                                <div className="border-b-4 border-gray">TIN LIÊN QUAN</div>
                    ...
                    <Tags/>
                    <div>
                        <div className="flex bg-white text-primary text-bold border-b-4 border-red">
                            <Link href="/Muc">
